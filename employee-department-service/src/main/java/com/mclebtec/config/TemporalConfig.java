...
public class TemporalConfig {
  ...
  public WorkflowServiceStubs workflowServiceStubs() {
    WorkflowServiceStubs workflowServiceStubs = (temporalServer.equalsIgnoreCase("local"))
        ...
        WorkflowServiceStubs
            .newServiceStubs(WorkflowServiceStubsOptions.newBuilder().setTarget(temporalUrl).build());
  ...
  public Worker employeeWorkerRegister(WorkerFactory workerFactory) {
    ...
    worker.registerActivitiesImplementations(new EmployeeDepartmentActivityImpl());
